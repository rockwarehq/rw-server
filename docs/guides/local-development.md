...
| `apps/workers` | Single worker binary with `--worker` startup modes (`rollups`, `imm-events`, `gateway-health`, `integration-events`) |
...
| `packages/livestore` | Reactive graph engine (see `docs/architecture/livestore-spec.md`) |
