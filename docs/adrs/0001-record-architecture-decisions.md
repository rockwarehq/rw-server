...
We will record significant architectural decisions as Architecture Decision Records under `docs/adrs/`. Each ADR follows [the template](./template.md) and the numbering convention described in the [ADR log](./README.md).
