  ...
  versions: {
    "1": {
      ...
      payload: {
        ...
        previousStatusReason: { type: "string", title: "Previous Reason Name", matchable: false },
        downtimeKind: { type: "string", title: "Downtime", enum: ["PLANNED", "UNPLANNED"] },
...
export function fromStationStatusEvent(e: StationStatusEvent): Record<string, unknown> {
  return {
    ...
    previousStatusReason: e.previousStatusReason,
    downtimeKind: e.isPlannedDown === undefined ? undefined : e.isPlannedDown ? "PLANNED" : "UNPLANNED",
