  ...
  versions: {
    "1": {
      ...
      payload: {
        ...
        openedByEmployeeName: { type: "string", title: "Opened By", matchable: false },
        closedByEmployeeId: { type: "string", title: "Closed By (Employee Id)", matchable: false },
        closedByEmployeeName: { type: "string", title: "Closed By", matchable: false },
...
export function fromCallEvent(e: CallEvent): Record<string, unknown> {
  return {
    ...
    openedByEmployeeName: e.openedByEmployeeName,
    closedByEmployeeId: e.closedByEmployeeId,
    closedByEmployeeName: e.closedByEmployeeName,
