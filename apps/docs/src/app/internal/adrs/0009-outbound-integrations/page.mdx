export const metadata = {
  title: '0009 – Outbound Integrations and Hook Trigger Binding',
  description:
    'ADR 0009: hooks stay terminal; IntegrationTrigger binds events to integration actions; secrets are encrypted with an environment-held key.',
}
...
- `packages/livestore/spec.md` §4.8 declares hooks **terminal event emitters**: a hook decides that
