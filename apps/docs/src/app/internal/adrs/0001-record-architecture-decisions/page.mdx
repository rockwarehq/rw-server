export const metadata = {
  ...
  description: 'ADR 0001: adopt Architecture Decision Records.',
}
...
We will record significant architectural decisions as Architecture Decision Records under `/internal/adrs`, rendered by the internal docs site. Each ADR follows [the template](/internal/adrs/template) and the numbering convention described in the [ADR log](/internal/adrs).
