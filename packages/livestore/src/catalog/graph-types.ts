  ...
  types: [
    {
      ...
      fields: [
        ...
        entityField(
          "status",
          "Status",
          "Live station status (FAST | SLOW | UP | DOWN)",
          "imm.station",
          "$input.stationId",
          "status",
          "string",
        ...
        entityField(
          "statusReasonId",
          "Status Reason Id",
          "Id of the current status reason",
          "imm.station",
          "$input.stationId",
          "statusReasonId",
          "string",
        ...
        entityField(
          "statusReason",
          "Status Reason",
          "Name of the current status reason",
          "imm.station",
          "$input.stationId",
          "statusReason",
          "string",
        ...
        entityField(
          "itemsPerCycle",
          "Items Per Cycle",
          "Item quantity created per completed cycle (standard quantity per cycle × the current job's active product quantities)",
          "imm.station",
          "$input.stationId",
          "itemsPerCycle",
          "number",
        ...
        entityField(
          "cycleMode",
          "Cycle Mode",
          "How the station's machine reports cycles (DISCRETE | QUANTITY_PER_CYCLE | QUANTITY_PER_INTERVAL)",
          "imm.station",
          "$input.stationId",
          "currentVersion.cycleMode",
          "string",
          15,
        ),
        entityField(
          "quantityUnit",
          "Quantity Unit",
          "Station's canonical unit for cycle and inventory quantities (e.g. ea, ft)",
          "imm.station",
          "$input.stationId",
        ...
        entityField(
          ...
          "Current Seconds Per Unit",
          "Effective standard seconds to produce one station unit for the running job (units/min = 60 ÷ this)",
          "imm.station",
          "$input.stationId",
          "currentSecondsPerUnit",
          "number",
        ...
        entityField(
          ...
          "Effective expected quantity per cycle for the running job (null for discrete)",
          "imm.station",
          "$input.stationId",
          "currentStandardQuantity",
          "number",
        ...
        entityField(
          ...
          "Current Standard Cycle Seconds",
          "Effective standard cycle seconds resolved for the running job",
          "imm.station",
          "$input.stationId",
          "currentStandardCycleSeconds",
          "number",
        ...
        entityField(
          "productionMode",
          "Production Mode",
          "Name of the active production mode (null when the station is not in a mode)",
          "imm.station",
          "$input.stationId",
          "productionMode",
          "string",
        ...
        entityField(
          "productionModeId",
          "Production Mode Id",
          "Id of the active production mode",
          "imm.station",
          "$input.stationId",
          "productionModeId",
          "string",
        ...
        entityField(
          ...
          "When the active production mode was forced",
          "imm.station",
          "$input.stationId",
          "productionModeStartAt",
          "date",
